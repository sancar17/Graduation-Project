...
#ython baselines/3D_attention_mt_UNet.py --device="cuda:0" --epochs=200 --limit=100 --ground_truth_dir="./" --data_raw_path="./yarisma_datasi/raw/" --log_file_name="yarisma_attention_mt200"